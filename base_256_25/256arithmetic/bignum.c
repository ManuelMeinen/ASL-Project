...
void inverse_256(radix25_t *res, radix25_t *x)
{
    ...
    //print_radix25(&z11, "z11");
    /* 22 */ square_256(&t, &z11);
    //print_radix25(&t, "t");
    /* 2^5 - 2^0 = 31 */ mul_256(&z2_5_0, &t, &z9);
    //print_radix25(&z2_5_0, "z2_5_0");
    ...
    //print_radix25(&z2_100_0, "z2_100_0");
