...
int pubKeyGen_opt_scalar_replacement_and_vectorize( char **sk, int num_test_cases ) {
...
int main( int argc, char **argv ) {
	...
	// - run benchmarking
	run_benchmarking( "../benchmark_framework", test_number, run_mode, be_verbose, res_dir_name, &pubKeyGen_opt_scalar_replacement_and_vectorize, &validate_base_256_17, &checkPk_base_256_17, "radix17", "Scalar replacement and vectorization in radix17 256 arithmetics", "opt_scalar_repl_and_vectorize" );
    return 0;
}
