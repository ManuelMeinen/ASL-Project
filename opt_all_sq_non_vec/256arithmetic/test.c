...
void test(){
    ...
    signed int reslo[8], reshi[8];
    signed int xlo[8] = {93848, 98738, 33478, 93614, 28872, 94227, 67689, 56183};
    signed int xhi[8] = {5696, 49829, 67138, 101447, 15544, 71231, 30135, 0};
    signed int res_sq_arrlo[8] = {74901, 3972, 81019, 112246, 67178, 78665, 127341, 67663};
    signed int res_sq_arrhi[8] = {63403, 41862, 87376, 130945, 47594, 395, 53540, 0};
    square_256_non_vec(reslo, reshi, xlo, xhi);
    
    if ( reslo[0] != res_sq_arrlo[0] ||
         reslo[1] != res_sq_arrlo[1] ||
         reslo[2] != res_sq_arrlo[2] ||
         reslo[3] != res_sq_arrlo[3] ||
         reslo[4] != res_sq_arrlo[4] ||
         reslo[5] != res_sq_arrlo[5] ||
         reslo[6] != res_sq_arrlo[6] ||
         reslo[7] != res_sq_arrlo[7] ||
		 reshi[0] != res_sq_arrhi[0] ||
		 reshi[1] != res_sq_arrhi[1] ||
		 reshi[2] != res_sq_arrhi[2] ||
		 reshi[3] != res_sq_arrhi[3] ||
		 reshi[4] != res_sq_arrhi[4] ||
		 reshi[5] != res_sq_arrhi[5] ||
		 reshi[6] != res_sq_arrhi[6] ||
		 reshi[7] != res_sq_arrhi[7] ) {
		printf( "reslo         = %d, %d, %d, %d, %d, %d, %d, %d\n", reslo[0], reslo[1], reslo[2], reslo[3], reslo[4], reslo[5], reslo[6], reslo[7] );
		printf( "expectedResLo = %d, %d, %d, %d, %d, %d, %d, %d\n", res_sq_arrlo[0], res_sq_arrlo[1], res_sq_arrlo[2], res_sq_arrlo[3], res_sq_arrlo[4], res_sq_arrlo[5], res_sq_arrlo[6], res_sq_arrlo[7] );
		printf( "reshi         = %d, %d, %d, %d, %d, %d, %d, %d\n", reshi[0], reshi[1], reshi[2], reshi[3], reshi[4], reshi[5], reshi[6], reshi[7] );
		printf( "expectedResHi = %d, %d, %d, %d, %d, %d, %d, %d\n", res_sq_arrhi[0], res_sq_arrhi[1], res_sq_arrhi[2], res_sq_arrhi[3], res_sq_arrhi[4], res_sq_arrhi[5], res_sq_arrhi[6], res_sq_arrhi[7] );
		printf( "Square alt failed\n" );
	}
	else {
		printf( "Square alt passed\n" );
	}
}
