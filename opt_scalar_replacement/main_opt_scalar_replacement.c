...
int main( int argc, char **argv ) {
	...
	run_benchmarking( "../benchmark_framework", test_number, run_mode, be_verbose, res_dir_name, &pubKeyGen_opt_scalar_replacement, &validate_base_256_17, &checkPk_base_256_17, "radix17", "Scalar replacement in radix17 256 arithmetics", "opt_scalar_replacement" );
    return 0;
}
