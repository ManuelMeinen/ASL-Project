...
int pubKeyGen_opt_curve_256_17( char **sk, int num_test_cases ) {
    myInt64 start, end;
	radix17_t Px, Py;
    int cycles = 0;
...
int main( int argc, char **argv ) {
	...
	// - run benchmarking
	run_benchmarking( "../benchmark_framework", test_number, run_mode, be_verbose, res_dir_name, &pubKeyGen_opt_curve_256_17, &validate_base_256_17, &checkPk_base_256_17, "radix17", "Base line implementation with optimized curve ops with 256 arithmetic (radix17)", "opt_curve" );
    return 0;
}
